...
FILE *open_input_data(const char *extdata_dir, const char *name)
{
    FILE *fpt = NULL;
    char buf[PATH_MAX];
...
void initialize_f1(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f2(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f3(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
    std::cout << "f3init " << nreal << std::endl;
    ...
    if (fpt==NULL) {
        std::cout << "f3 is only defined for D2, D10, D30 and D50" << std::endl;
        exit(1);
    }
    for (i = 0; i < nreal; i++) {
        for (j = 0; j < nreal; j++) {
...
void initialize_f4(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
    fpt = open_input_data(extdata_dir, "schwefel_102_data.txt");
...
void initialize_f5(const char *extdata_dir)
{
    int i, j;
    int index;
    FILE *fpt = NULL;
...
void initialize_f6(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f7(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f8(const char *extdata_dir)
{
    int i, j;
    int index;
    FILE *fpt = NULL;
...
void initialize_f9(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f10(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f11(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f12(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
    char c;
...
void initialize_f13(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f14(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
...
void initialize_f15(const char *extdata_dir)
{
    int i, j;
    FILE *fpt = NULL;
    char c;
...
void initialize_f16(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f17(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f18(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f19(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f20(const char *extdata_dir)
{
    int i, j, k;
    int index;
    FILE *fpt = NULL;
...
void initialize_f21(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f22(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f23(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
...
void initialize_f24_f25(const char *extdata_dir)
{
    int i, j, k;
    FILE *fpt = NULL;
    char c;
